...
function TableBody({ coin }: { coin: CoinProps }) {
  return (
    <tr>
      <TableDetail image={true} text={coin.image} TWstyle=" w-full sticky -left-1  bg-white" >{null}</TableDetail>
      <TableDetail TWstyle="sticky bg-white left-14  rounded-r-2xl ">{coin.symbol}</TableDetail>
